...
[![patentsview status badge](https://mustberuss.r-universe.dev/patentsview/badges/version)](https://mustberuss.r-universe.dev/patentsview)
...
The new version of the API requires an API key, or all of your requests will be blocked.  An API key can be obtained [here](https://patentsview-support.atlassian.net/servicedesk/customer/portals).  The updated R package will look for an environmental variable PATENTSVIEW_API_KEY set to the value of your key. For windows it would be
```
