...
* The endpoints are now singluar, patent for example, where in the past they were plural, patents
for example.  The R package will display a warning if the plural name is used but the singular name will be used when calling the api.  There would be a small chance that an existing script would work, once the now-required api key is set up.
...
#> [28] "inventors_at_grant.inventor"                                 
#> [29] "inventors_at_grant.name_first"                               
#> [30] "inventors_at_grant.name_last"                                
#> [31] "inventors_at_grant.city"                                     
#> [32] "inventors_at_grant.state"                                    
#> [33] "inventors_at_grant.country"                                  
#> [34] "cpc_current.cpc_subsection"                                  
#> [35] "cpc_current.cpc_group"                                       
#> [36] "cpc_current.cpc_subgroup_id"                                 
#> [37] "cpc_current.cpc_group_title"
```
