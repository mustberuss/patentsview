...
had a 'format' parameter that defaulted to json but could be set to xml.
...
```
* The original [ropensci_blog_post](ropensci_blog_post.html) was reworked to use the new version of the API
