...
#> [1] "https://search.patentsview.org/api/v1/patent/?q=%7B%22patent_type%22%3A%22utility%22%7D&f=&s=&o={\"size\":1000}"
#> GET /api/v1/patent/?q=%7B%22patent_type%22%3A%22utility%22%7D&f=&s=&o={"size": 1000} HTTP/1.1
#> Host: search.patentsview.org
#> User-Agent: https://github.com/ropensci/patentsview
#> Accept: */*
#> Accept-Encoding: deflate, gzip
#> X-Api-Key: 51vvjuNE.DT0Ztuy39IkBelX4a087QBhun3HqXjCG
#> 
#> -> GET /api/v1/patent/?q=%7B%22patent_type%22%3A%22utility%22%7D&f=&s=&o={"size": 1000} HTTP/1.1
#> -> Host: search.patentsview.org
#> -> User-Agent: https://github.com/ropensci/patentsview
...
#> -> 
#> <- HTTP/1.1 200 OK
#> <- Date: Sun, 20 Oct 2024 21:21:35 GMT
#> <- Content-Type: application/json
#> <- Content-Length: 129120
...
#> [1] "https://search.patentsview.org/api/v1/patent/?q=%7B%22patent_id%22%3A%20%2211530080%22%7D&f=&s=&o={\"size\":1000}"
#> GET /api/v1/patent/?q=%7B%22patent_id%22%3A%20%2211530080%22%7D&f=&s=&o={"size": 1000} HTTP/1.1
#> Host: search.patentsview.org
#> User-Agent: https://github.com/ropensci/patentsview
#> Accept: */*
#> Accept-Encoding: deflate, gzip
...
#> [1] "https://search.patentsview.org/api/v1/patent/?q=%7B%22patent_id%22%3A%20%2211530080%22%7D&f=[\"patent_id\",\"cpc_current.cpc_class\",\"cpc_current.cpc_class_id\",\"cpc_current.cpc_group\",\"cpc_current.cpc_group_id\",\"cpc_current.cpc_section\",\"cpc_current.cpc_sequence\",\"cpc_current.cpc_subclass\",\"cpc_current.cpc_subclass_id\",\"cpc_current.cpc_type\"]&s=&o={\"size\":1000}"
#> GET /api/v1/patent/?q=%7B%22patent_id%22%3A%20%2211530080%22%7D&f=["patent_id","cpc_current.cpc_class","cpc_current.cpc_class_id","cpc_current.cpc_group","cpc_current.cpc_group_id","cpc_current.cpc_section","cpc_current.cpc_sequence","cpc_current.cpc_subclass","cpc_current.cpc_subclass_id","cpc_current.cpc_type"]&s=&o={"size": 1000} HTTP/1.1
#> Host: search.patentsview.org
#> User-Agent: https://github.com/ropensci/patentsview
#> Accept: */*
#> Accept-Encoding: deflate, gzip
...
#> -> 
#> <- HTTP/1.1 200 OK
#> <- Date: Sun, 20 Oct 2024 21:21:36 GMT
#> <- Content-Type: application/json
#> <- Content-Length: 2919
#> <- Connection: keep-alive
#> <- Server: nginx
...
#> [1] "https://search.patentsview.org/api/v1/cpc_group/G01S7:4865/?q=&f=&s=&o="
#> GET /api/v1/cpc_group/G01S7: 4865/?q=&f=&s=&o= HTTP/1.1
#> Host: search.patentsview.org
#> User-Agent: https://github.com/ropensci/patentsview
#> Accept: */*
#> Accept-Encoding: deflate, gzip
...
#> [1] "https://search.patentsview.org/api/v1/patent/?q=%7B%22patent_id%22%3A%227861317%22%7D&f=&s=&o="
#> GET /api/v1/patent/?q=%7B%22patent_id%22%3A%227861317%22%7D&f=&s=&o= HTTP/1.1
#> Host: search.patentsview.org
#> User-Agent: https://github.com/ropensci/patentsview
#> Accept: */*
#> Accept-Encoding: deflate, gzip
...
#> [1] "https://search.patentsview.org/api/v1/cpc_group/?q=%7B%22cpc_group_id%22%3A%20%22A01B1%2F00%22%7D&f=&s=&o={\"size\":1000}"
#> GET /api/v1/cpc_group/?q=%7B%22cpc_group_id%22%3A%20%22A01B1%2F00%22%7D&f=&s=&o={"size": 1000} HTTP/1.1
#> Host: search.patentsview.org
#> User-Agent: https://github.com/ropensci/patentsview
#> Accept: */*
#> Accept-Encoding: deflate, gzip
...
#> -> 
#> <- HTTP/1.1 200 OK
#> <- Date: Sun, 20 Oct 2024 21:21:37 GMT
#> <- Content-Type: application/json
#> <- Content-Length: 255
#> <- Connection: keep-alive
#> <- Server: nginx
...
#> [1] "https://search.patentsview.org/api/v1/patent/?q=%7B%22patent_id%22%3A%2210000000%22%7D&f=[\"inventors.inventor_id\",\"assignees.assignee_id\"]&s=&o={\"size\":1000}"
#> GET /api/v1/patent/?q=%7B%22patent_id%22%3A%2210000000%22%7D&f=["inventors.inventor_id","assignees.assignee_id"]&s=&o={"size": 1000} HTTP/1.1
#> Host: search.patentsview.org
#> User-Agent: https://github.com/ropensci/patentsview
#> Accept: */*
#> Accept-Encoding: deflate, gzip
...
search_pv(query1)
#> [1] "https://search.patentsview.org/api/v1/patent/?q=%7B%22_contains%22%3A%7B%22patent_title%22%3A%22dog%22%7D%7D&f=&s=&o={\"size\":1000}"
#> GET /api/v1/patent/?q=%7B%22_contains%22%3A%7B%22patent_title%22%3A%22dog%22%7D%7D&f=&s=&o={"size": 1000} HTTP/1.1
#> Host: search.patentsview.org
#> User-Agent: https://github.com/ropensci/patentsview
#> Accept: */*
#> Accept-Encoding: deflate, gzip
...
#> -> 
#> <- HTTP/1.1 200 OK
#> <- Date: Sun, 20 Oct 2024 21:21:39 GMT
#> <- Content-Type: application/json
#> <- Content-Length: 124489
#> <- Connection: keep-alive
#> <- Server: nginx
#> <- Vary: Accept, origin
#> <- Allow: GET, POST, HEAD, OPTIONS
...
search_pv(query2)
#> [1] "https://search.patentsview.org/api/v1/patent/?q=%7B%22_text_any%22%3A%7B%22patent_title%22%3A%22dog%22%7D%7D&f=&s=&o={\"size\":1000}"
#> GET /api/v1/patent/?q=%7B%22_text_any%22%3A%7B%22patent_title%22%3A%22dog%22%7D%7D&f=&s=&o={"size": 1000} HTTP/1.1
#> Host: search.patentsview.org
#> User-Agent: https://github.com/ropensci/patentsview
#> Accept: */*
#> Accept-Encoding: deflate, gzip
...
#> [1] "https://search.patentsview.org/api/v1/brf_sum_text/?q=%7B%22_contains%22%3A%7B%22summary_text%22%3A%22paper%20cup%20holder%22%7D%7D&f=&s=&o={\"size\":1000}"
#> GET /api/v1/brf_sum_text/?q=%7B%22_contains%22%3A%7B%22summary_text%22%3A%22paper%20cup%20holder%22%7D%7D&f=&s=&o={"size": 1000} HTTP/1.1
#> Host: search.patentsview.org
#> User-Agent: https://github.com/ropensci/patentsview
#> Accept: */*
#> Accept-Encoding: deflate, gzip
...
#> -> 
#> <- HTTP/1.1 200 OK
#> <- Date: Sun, 20 Oct 2024 21:21:41 GMT
#> <- Content-Type: application/json
#> <- Content-Length: 59
#> <- Connection: keep-alive
#> <- Server: nginx
...
#> [1] "https://search.patentsview.org/api/v1/brf_sum_text/?q=%7B%22_text_phrase%22%3A%7B%22summary_text%22%3A%22paper%20cup%20holder%22%7D%7D&f=&s=&o={\"size\":1000}"
#> GET /api/v1/brf_sum_text/?q=%7B%22_text_phrase%22%3A%7B%22summary_text%22%3A%22paper%20cup%20holder%22%7D%7D&f=&s=&o={"size": 1000} HTTP/1.1
#> Host: search.patentsview.org
#> User-Agent: https://github.com/ropensci/patentsview
#> Accept: */*
#> Accept-Encoding: deflate, gzip
...
#> [1] "https://search.patentsview.org/api/v1/assignee/?q=%7B%22assignee_organization%22%3A%20%22Johnson%20%26%20Johnson%20International%22%7D&f=&s=&o={\"size\":1000}"
#> GET /api/v1/assignee/?q=%7B%22assignee_organization%22%3A%20%22Johnson%20%26%20Johnson%20International%22%7D&f=&s=&o={"size": 1000} HTTP/1.1
#> Host: search.patentsview.org
#> User-Agent: https://github.com/ropensci/patentsview
#> Accept: */*
#> Accept-Encoding: deflate, gzip
...
#> -> 
#> <- HTTP/1.1 200 OK
#> <- Date: Sun, 20 Oct 2024 21:21:42 GMT
#> <- Content-Type: application/json
#> <- Content-Length: 55
#> <- Connection: keep-alive
#> <- Server: nginx
...
#> [1] "https://search.patentsview.org/api/v1/assignee/?q=%7B%22_eq%22%3A%7B%22assignee_organization%22%3A%20%22Johnson%20%26%20Johnson%20International%22%7D%7D&f=&s=&o={\"size\":1000}"
#> GET /api/v1/assignee/?q=%7B%22_eq%22%3A%7B%22assignee_organization%22%3A%20%22Johnson%20%26%20Johnson%20International%22%7D%7D&f=&s=&o={"size": 1000} HTTP/1.1
#> Host: search.patentsview.org
#> User-Agent: https://github.com/ropensci/patentsview
#> Accept: */*
#> Accept-Encoding: deflate, gzip
...
#> -> 
#> <- HTTP/1.1 200 OK
#> <- Date: Sun, 20 Oct 2024 21:21:43 GMT
#> <- Content-Type: application/json
#> <- Content-Length: 55
#> <- Connection: keep-alive
#> <- Server: nginx
