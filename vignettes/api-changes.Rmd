...
## HATEOAS
Some of the returned fields are links to retrieve more information about that field. Slight funky is the cpc_current's cpc_subgroup, returned by the patents endpoint.  Here the slash in the cpc is turned into a colon.  This is a picularity of two of the new convience urls that shouldn't be noticable in the r package, unless you are trying to infer the uspc and cpc values from the returned urls.
...
#> [34] "cpc_current.sequence"                                        
#> [35] "cpc_current.section_id"                                      
#> [36] "cpc_current.subsection_id"                                   
#> [37] "cpc_current.group_id"                                        
#> [38] "cpc_current.subgroup_id"                                     
#> [39] "cpc_current.cpc_group_title"
```
