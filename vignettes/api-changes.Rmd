...
#>   ..$ patent_id   : chr [1:1000] "3930271" ...
#>   ..$ patent_title: chr [1:1000] "Golf glove" ...
...
* Three methods were added
   ...
   + qry_funs$in_range() will generate range based queries for you:
...
#> List of 1
#>  $ patents:'data.frame':	1000 obs. of  3 variables:
#>   ..$ patent_id   : chr [1:1000] "3937418" ...
#>   ..$ patent_title: chr [1:1000] "Retractable dog leash" ...
#>   ..$ patent_date : chr [1:1000] "1976-02-10" ...
#> 
#> $query_results
#> #### Distinct entity counts across all downloadable pages of output:
#> 
