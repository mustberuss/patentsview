...
X-Api-Key header.  The response will be an http 403 Forbidden, instead of a 200.  The R package has
a new method 
...
#> [30] "inventors_at_grant.inventor"                                 
...
#> [43] "cpc_current.cpc_group_title"
```
