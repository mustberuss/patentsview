...
As noted below, the R package handles some of the changes for users.  All the changes are listed for completeness.
...
[API changes](#summary-of-the-api-changes) outlined above
...
fields/f: parameter and each field is supposed to be queryable (usable in the query/q: 
