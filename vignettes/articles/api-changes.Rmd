...
to the names originally released) listed under "Patent Text" but now there are four more
 pre-grant (pg_) endpoints listed under "Publication Text".
    ...
    It looks like the TextEndpointStatus page isn't being updated frequently, so we'll check 
...
#> [1] "https://search.patentsview.org/api/v1/assignee/a4b14180-6e72-4316-bf91-4f27cdd22bcd/"
