...
```
For completeness, not sure why someone would want withdrawn patents.   
patent_ids from test_that("Withdrawn patents are suppressed by default but some are present in the database")
