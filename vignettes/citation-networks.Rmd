...
# (api currently throws a 500 error)
# query <- qry_funs$contains(cpc_current.cpc_subgroup_id = "Y10S707:933")
query <- qry_funs$contains(patent_number = "10000000")

# Create a list of fields to pull from the API
fields <- c(
  "patent_number", 
  "patent_title",
  "patent_num_us_patents_cited", # Which patents do these patents cite?
  "patent_num_times_cited_by_us_patents" # Which patents cite them?
)
