...
res_lst2
#> List of 1
#>  $ us_patent_citations:'data.frame':	1056 obs. of  3 variables:
#>   ..$ patent_id         : chr [1:1056] "10007946" ...
#>   ..$ citation_sequence : int [1:1056] 53 13 ...
#>   ..$ citation_patent_id: chr [1:1056] "7716226" ...
```

## Count the distinct patent_id and cited_patent_id

There are only 11 PCA patents. These patents cite 1066 patents and are cited by 1056 patents. Let's visualize the citations among the PCA patents. We'll create our visualization using the `visNetwork` package, which requires us to create a data frame of nodes and a data frame of edges.
