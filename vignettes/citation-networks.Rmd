...
res_lst2
#> List of 1
#>  $ us_patent_citations:'data.frame':	1028 obs. of  3 variables:
#>   ..$ patent_id         : chr [1:1028] "6480854" ...
#>   ..$ citation_sequence : int [1:1028] 4 2 ...
...
Now we know which patents the 1007 relevant patents cite. This allows us to measure the similarity between the 1007 patents by seeing how many cited references they share in common (a method known as [bibliographic coupling](https://en.wikipedia.org/wiki/Bibliographic_coupling)).
