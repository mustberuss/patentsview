...
res_lst2
#> List of 1
#>  $ us_patent_citations:'data.frame':	998 obs. of  2 variables:
#>   ..$ patent_id         : chr [1:998] "10007946" ...
#>   ..$ citation_patent_id: chr [1:998] "7716226" ...
```

# Count the distinct patent_id and cited_patent_id

There are only 11 PCA patents. These patents cite 1037 patents and are cited by 998 patents. Let's visualize the citations among the PCA patents. We'll create our visualization using the `visNetwork` package, which requires us to create a data frame of nodes and a data frame of edges.
