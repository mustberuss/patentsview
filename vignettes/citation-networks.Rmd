...
There are only 11 PCA patents. These patents cite 1066 patents and are cited by 1101 patents. Let's visualize the citations among the PCA patents. We'll create our visualization using the `visNetwork` package, which requires us to create a data frame of nodes and a data frame of edges.
