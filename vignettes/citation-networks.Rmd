...
res <- search_pv(citing_query, fields = fields, all_pages = TRUE, endpoint = "patent_citation", method = "GET")
...
res2 <- search_pv(cited_query , fields = fields, all_pages = TRUE, endpoint = "patent_citation", method = "GET")
...
rel_pats_res <- search_pv(
  ...
  all_pages = TRUE, method = "POST", endpoint = "patent_citation"
)
