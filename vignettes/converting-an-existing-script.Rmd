...
#> [1] "3984 2021-04-27, 2022-07-16"
```

## Conclusion

So there you have it, our attempt at listing what's changed and what to do about it.  [Request](https://patentsview.org/apis/keyrequest) an API key and get going with the new R package for the new version of the API! (The two API versions will coexist for a while but eventually the original version of the API will be retired.)
