...
# and allow a start date to be passed in.  The caller might want to pick up where they
# left off last time
...
#> [1] "The api's requests per minute limit has been reached.  Pausing for 5 seconds before continuing."
#> [1] "API calls made: 29"
