...
#> The API's requests per minute limit has been reached. Pausing for 14 seconds before continuing.
...
#> The API's requests per minute limit has been reached. Pausing for 24 seconds before continuing.
...
fields
#> [1] "patent_id"                     "inventors.inventor_city"      
#> [3] "inventors.inventor_country"    "inventors.inventor_id"        
