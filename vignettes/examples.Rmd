...
# Create a field list
inv_fields <- get_fields(endpoint = "patent", groups = "inventors_at_grant")
...
#> [1] "https://search.patentsview.org/api/v1/patent/?q=%7B%22_and%22%3A%5B%7B%22_gte%22%3A%7B%22patent_date%22%3A%222019-07-30%22%7D%7D%2C%7B%22_text_phrase%22%3A%7B%22assignees_at_grant.organization%22%3A%22microsoft%22%7D%7D%5D%7D&f=[\"inventors_at_grant.inventor\",\"inventors_at_grant.name_first\",\"inventors_at_grant.name_last\",\"inventors_at_grant.city\",\"inventors_at_grant.state\",\"inventors_at_grant.country\",\"patent_number\"]&o={\"offset\":7000,\"size\":1000}&s="

# Unnest the inventor list column
unnest_pv_data(pv_out$data, "patent_number")
#> List of 2
#>  $ inventors_at_grant:'data.frame':	22801 obs. of  6 variables:
#>   ..$ patent_number: chr [1:22801] "10733252" ...
#>   ..$ name_first   : chr [1:22801] "Yongzheng" ...
#>   ..$ name_last    : chr [1:22801] "Zhang" ...
#>   ..$ city         : chr [1:22801] "San Jose" ...
#>   ..$ state        : chr [1:22801] "CA" ...
#>   ..$ country      : chr [1:22801] "US" ...
#>  $ patents           :'data.frame':	5703 obs. of  1 variable:
#>   ..$ patent_number: chr [1:5703] "10733252" ...
```
