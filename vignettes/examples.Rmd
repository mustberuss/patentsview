...
# Create a field list by getting the top level (non nested) fields
inv_fields <- get_fields(endpoint = "patent", groups = "")
...
#> List of 1
#>  $ patents:'data.frame':	3600 obs. of  18 variables:
#>   ..$ patent_id                                                   : chr [1:36"..
#>   ..$ patent_title                                                : chr [1:36"..
#>   ..$ patent_type                                                 : chr [1:36"..
#>   ..$ patent_date                                                 : chr [1:36"..
#>   ..$ patent_year                                                 : int [1:360..
#>   ..$ patent_abstract                                             : chr [1:36"..
#>   ..$ patent_cpc_current_group_average_patent_processing_days     : int [1:360..
#>   ..$ patent_detail_desc_length                                   : int [1:360..
#>   ..$ patent_earliest_application_date                            : chr [1:36"..
#>   ..$ patent_num_foreign_documents_cited                          : int [1:360..
#>   ..$ patent_num_times_cited_by_us_patents                        : int [1:360..
#>   ..$ patent_num_total_documents_cited                            : int [1:360..
#>   ..$ patent_num_us_applications_cited                            : int [1:360..
#>   ..$ patent_num_us_patents_cited                                 : int [1:360..
#>   ..$ patent_processing_days                                      : int [1:360..
#>   ..$ patent_term_extension                                       : int [1:360..
#>   ..$ gov_interest_statement                                      : chr [1:360..
#>   ..$ patent_uspc_current_mainclass_average_patent_processing_days: logi [1:36..
```
