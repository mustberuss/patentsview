...
#> List of 2
#>  $ inventors:'data.frame':	16124 obs. of  8 variables:
#>   ..$ patent_id          : chr [1:16124] "11397055" ...
#>   ..$ inventor           : chr [1:16124] "https://search.patentsview.org/api/"..
#>   ..$ inventor_name_first: chr [1:16124] "Tzu-Yuan" ...
#>   ..$ inventor_name_last : chr [1:16124] "Lin" ...
#>   ..$ inventor_city      : chr [1:16124] "San Jose" ...
#>   ..$ inventor_state     : chr [1:16124] "CA" ...
#>   ..$ inventor_country   : chr [1:16124] "US" ...
#>   ..$ inventor_sequence  : int [1:16124] 1 2 ...
#>  $ patents  :'data.frame':	4003 obs. of  1 variable:
#>   ..$ patent_id: chr [1:4003] "11397055" ...
```
