...
#> [1] "The api's requests per minute limit has been reached.  Pausing for 6 seconds before continuing."
#> Warning in one_request(method, query, base_url, arg_list, ...): The api's
#> requests per minute limit has been reached. Pausing for 6 seconds before
#> continuing.
#> $data
#> [1] "patents"
