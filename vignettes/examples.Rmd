...
#>  [1] "Microsoft Licensing Technology, LLC."            
#>  [2] "Microsoft Technology Beaming, LLC"               
#>  [3] "Microsoft Corporation"                           
#>  [4] "Hitachi Microsoftware Systems, Inc."             
#>  [5] "Microsoft Israel Research and Development (2002)"
#>  [6] "Microsoft Orthopedics Holdings Inc."             
#>  [7] "Microsoft Technology Licensing, LLC"             
#>  [8] "Microsoft Mobile Oy"                             
#>  [9] "Microsoft Technology Learning, LLC"              
#> [10] "MICROSOFT INTERNATIONAL HOLDINGS B.V."           
#> [11] "Microsoft Mobile Internet AB"                    
#> [12] "Microsoft Corporation—One Microsoft Way"         
#> [13] "Tangis Corporation Microsoft Corporation"        
#> [14] "Microsoft Systems Inc."                          
#> [15] "MS1 - Microsoft Corporation"                     
#> [16] "Sun Microsoft, Inc."                             
#> [17] "MICROSOFT TECHNOLOGY, LLC"                       
#> [18] "Microsoft Licencing Corporation, LLC"            
#> [19] "Microsoft Patent Licensing, LLC"                 
#> [20] "WebTV Networks Inc. (Microsoft)"
```
...
#> List of 2
#>  $ inventors:'data.frame':	8779 obs. of  8 variables:
#>   ..$ patent_id          : chr [1:8779] "11397055" ...
#>   ..$ inventor           : chr [1:8779] "https://search.patentsview.org/api/v"..
#>   ..$ inventor_name_first: chr [1:8779] "Tzu-Yuan" ...
#>   ..$ inventor_name_last : chr [1:8779] "Lin" ...
#>   ..$ inventor_city      : chr [1:8779] "San Jose" ...
#>   ..$ inventor_state     : chr [1:8779] "CA" ...
#>   ..$ inventor_country   : chr [1:8779] "US" ...
#>   ..$ inventor_sequence  : int [1:8779] 1 2 ...
#>  $ patents  :'data.frame':	2184 obs. of  1 variable:
#>   ..$ patent_id: chr [1:2184] "11397055" ...
```
...
#> 
#> List of 1
#>  $ patents:'data.frame':	577 obs. of  3 variables:
#>   ..$ patent_id   : chr [1:577] "10000326" ...
#>   ..$ patent_title: chr [1:577] "Plastic beer keg" ...
#>   ..$ patent_date : chr [1:577] "2018-06-19" ...
#> 
#> $query_results
#> #### Distinct entity counts across all downloadable pages of output:
#> 
