...
#>   ..$ patent_id   : chr [1:1000] "3939350" ...
#>   ..$ patent_title: chr [1:1000] "Fluorescent immunoassay employing total ref"..
#>   ..$ patent_date : chr [1:1000] "1976-02-17" ...
#> 
#> $query_results
...
#>  [3] "Microsoft Orthopedics Holdings Inc."             
#>  [4] "MICROSOFT INTERNATIONAL HOLDINGS B.V."           
#>  [5] "Microsoft Systems Inc."                          
#>  [6] "Microsoft Technology Licensing, LLC"             
#>  [7] "Microsoft Mobile Oy"                             
#>  [8] "Microsoft Technology, LLC."                      
#>  [9] "Microsoft Technology Beaming, LLC"               
#> [10] "Microsoft Technology Learning, LLC"              
#> [11] "Microsoft Israel Research and Development (2002)"
#> [12] "Microsoft Licensing Technology, LLC"             
#> [13] "Microsoft Patent Licensing, LLC"                 
#> [14] "Microsoft Licencing Corporation, LLC"            
#> [15] "Microsoft Corporation—One Microsoft Way"
```
...
#> 
#> List of 1
#>  $ patents:'data.frame':	600 obs. of  3 variables:
#>   ..$ patent_id   : chr [1:600] "3930592" ...
#>   ..$ patent_title: chr [1:600] "Beer can structure" ...
#>   ..$ patent_date : chr [1:600] "1976-01-06" ...
#> 
#> $query_results
#> #### Distinct entity counts across all downloadable pages of output:
#> 
