...
#> Error: Bad field(s): patent_number
result
...
```r
search_pv(
  query = qry_funs$eq(inventors.inventors_name_last = "chambers"),
  all_pages = TRUE, per_page = 1000
)
#> Error: inventors.inventors_name_last is not a valid field to query for your endpoint
```
...
inv_fields
#> [1] "inventors.inventor_sequence"    "inventors.inventor_city"       
#> [3] "inventors.inventor_state"       "inventors.inventor_name_first" 
#> [5] "inventors.inventor_country"     "inventors.inventor_id"         
#> [7] "inventors.inventor_name_last"   "inventors.inventor_location_id"
...
#> Error: name_last is not a valid field to query for your endpoint
```
...
#> Error in prsd_resp[[4]]: subscript out of bounds

res
#> $data
#> #### A list with a single data frame on us_patent_citations level:
#> 
#> List of 1
#>  $ us_patent_citations:'data.frame':	1037 obs. of  2 variables:
#>   ..$ patent_id         : chr [1:1037] "10095778" ...
#>   ..$ citation_patent_id: chr [1:1037] "6430539" ...
#> 
#> $query_results
#> #### Distinct entity counts across all downloadable pages of output:
#> 
...
#> Error: patent_number not in primary entity data frame...Did you include it in your fields list?
```
