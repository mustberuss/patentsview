...
In the original version of the API, rawinventor_first_name and rawinventor_last_name were available from the patents, inventors and assignees endpoints. **In the new version of the API these felds are no longer available.**
