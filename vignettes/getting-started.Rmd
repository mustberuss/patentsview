...
#> [1] "https://search.patentsview.org/api/v1/patent/?q=%7B%22_gte%22%3A%7B%22patent_date%22%3A%222007-01-01%22%7D%7D&f=&s=&o={\"size\":1000,\"after\":\"\"}"
#> Waiting 20s for retry backoff ■■ Waiting 20s for retry backoff ■■■ Waiting 20s
#> for retry backoff ■■■ Waiting 20s for retry backoff ■■■ Waiting 20s for retry
#> backoff ■■■■ Waiting 20s for retry backoff ■■■■ Waiting 20s for retry backoff
#> ■■■■ Waiting 20s for retry backoff ■■■■ Waiting 20s for retry backoff ■■■■■
#> Waiting 20s for retry backoff ■■■■■ Waiting 20s for retry backoff ■■■■■ Waiting
#> 20s for retry backoff ■■■■■■ Waiting 20s for retry backoff ■■■■■■ Waiting 20s
#> for retry backoff ■■■■■■ Waiting 20s for retry backoff ■■■■■■■ Waiting 20s for
#> retry backoff ■■■■■■■ Waiting 20s for retry backoff ■■■■■■■ Waiting 20s for
#> retry backoff ■■■■■■■■ Waiting 20s for retry backoff ■■■■■■■■ Waiting 20s for
#> retry backoff ■■■■■■■■ Waiting 20s for retry backoff ■■■■■■■■■ Waiting 20s for
...
#> [1] "https://search.patentsview.org/api/v1/patent/?q=%7B%22_gte%22%3A%7B%22patent_date%22%3A%222007-01-01%22%7D%7D&f=[\"patent_id\",\"patent_title\"]&s=&o={\"size\":1000,\"after\":\"\"}"
result
#> $data
#> #### A list with a single data frame on patents level:
#> 
...
#> [1] "https://search.patentsview.org/api/v1/patent/?q=%7B%22_eq%22%3A%7B%22inventors.inventor_name_last%22%3A%22Chambers%22%7D%7D&f=[\"patent_id\"]&s=[{\"patent_id\":\"asc\"}]&o={\"size\":1000,\"after\":\"\"}"
#> [1] "https://search.patentsview.org/api/v1/patent/?q=%7B%22_eq%22%3A%7B%22inventors.inventor_name_last%22%3A%22Chambers%22%7D%7D&f=[\"patent_id\"]&s=[{\"patent_id\":\"asc\"}]&o={\"size\":1000,\"after\":\"\"}"
...
#> [1] "https://search.patentsview.org/api/v1/patent/?q=%7B%22patent_id%22%3A%225116621%22%7D&f=[\"patent_id\",\"patent_date\",\"patent_title\",\"patent_year\",\"assignees.assignee_type\"]&s=&o={\"size\":1000,\"after\":\"\"}"
