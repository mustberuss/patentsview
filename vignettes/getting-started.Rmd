...
#> 
#> List of 1
#>  $ patents:'data.frame':	2487 obs. of  3 variables:
#>   ..$ patent_id   : chr [1:2487] "3931611" ...
#>   ..$ patent_title: chr [1:2487] "Program event recorder and data processing "..
#>   ..$ patent_date : chr [1:2487] "1976-01-06" ...
#> 
#> $query_results
#> #### Distinct entity counts across all downloadable pages of output:
#> 
...
fields <- get_fields(endpoint = "patent", groups ="inventors", include_pk = TRUE)
fields
#> [1] "patent_id" "inventors"
...
#>   ..$ patent_title              : chr [1:1000] "Fuel control system for gas t"..
#>   ..$ patent_date               : chr [1:1000] "1976-01-06" ...
...
#> 1 3930365   Fuel contro… 1976-0… <df>    https:… 3       <NA>    <NA>    Joseph…
#> 2 3930518   Valves       1976-0… <df>    https:… 3       <NA>    <NA>    Hopkin…
#> 3 3930607   Container a… 1976-0… <df>    https:… 2       <NA>    <NA>    Philli…
#> 4 3930635   Leak-proof … 1976-0… <df>    https:… 2       <NA>    <NA>    Xomox …
#> 5 3930874   Bonded fuse… 1976-0… <df>    https:… 2       <NA>    <NA>    Cornin…
#> 6 3930915   Method of m… 1976-0… <df>    https:… 2       <NA>    <NA>    Westin…
...
#>  $ patents                   :'data.frame':	1000 obs. of  3 variables:
#>   ..$ patent_id   : chr [1:1000] "3930365" ...
#>   ..$ patent_title: chr [1:1000] "Fuel control system for gas turbine engine" ..
#>   ..$ patent_date : chr [1:1000] "1976-01-06" ...
```
