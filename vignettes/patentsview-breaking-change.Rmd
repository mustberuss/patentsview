...
4. Some field's names have changed, most significantly, patent_number is now patent_id,
 and some fields were removed entirely.
...
In a similar format, the [updated API documentation](https://search.patentsview.org/docs/docs/Search%20API/SearchAPIReference/) 
lists what each endpoint does.  Additionally, the R package's fieldsdef data frame has been updated, now listing the new set 
of endpoints and retrievable/queryable fields.  The package's reference pages have been also updated.
