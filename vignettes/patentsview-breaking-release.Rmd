...
however an API key is now required. The original version of the API was shut down in early 2025, and the original version of the R package no longer works.

The new version of the R package is available on CRAN and [r-universe](https://ropensci.r-universe.dev/patentsview).
