...
**Note: A recent API release seems to have broken or at least 
changed paging.**  This used to work,
...
``` r
   ...
   if(result$query_results$count < result$query_results$total_hits)
   {
     ...
     after = list(
       ...
       # slight, hopefully temporary, hiccup as we pad as mentioned above
       pad_patent_id(
