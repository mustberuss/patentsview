...
#> Error: Bad field(s): patent_average_processing_time, inventor_first_name, inventor_total_num_patents
```
...
#> 
#> List of 1
#>  $ patents:'data.frame':	25 obs. of  19 variables:
...
#>   ..$ patent_term_extension                                       : int [1:25]..
...
qry
#> {"_text_any":{"cpc_subgroup_id":"H04L63/02"}}
