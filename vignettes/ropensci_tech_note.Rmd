...
5. The [ropensci post](https://ropensci.org/blog/2017/09/19/patentsview/) announcing the original version of the R package has been modified to work with the new version of the API and is now a new vignette.
6. A hex logo was created using GuangchuangYu's [hexSticker](https://github.com/GuangchuangYu/hexSticker)
