...
* A new vignette, inspired by the API team's jupyter notebook, was created showing two of the things it mentions
  ...
  1. The API and R package now allow nested attributes to be [wildcarded](understanding-the-api.html#fields-shorthand),
...
https://github.com/bergant/rapiclient/issues/11   The R version of the fieldsdf creator
(not currently working) uses rapiclient but it's expecting to read a Swagger/OpenAPI v2 object
