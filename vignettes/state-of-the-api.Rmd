...
the new way of paging.  Possibly just say to see the new [api paging vignette](api-paging.html)?
...
<br />
<br />
   + Run code coverage locally on the whole package: ```devtools::test_coverage()```
or an individual file: ```devtools::test_coverage_active_file(file = "R/print.R")``` You'd need to have covr installed
<br />
<br />
* Remotely
