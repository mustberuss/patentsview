...
Unknown Reference Number  
Paging seems broken with the most recent release but I'm not able to report it yet.
test_that("the 'after' parameter works properly") in test-search-pv.R broke.
Its first request has a total_hits of 3003 with 1000 rows returned but the
subsequent request returns 399 rows.
