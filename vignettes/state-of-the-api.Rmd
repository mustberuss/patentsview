...
To not burry the lead, the 2024-11-06 API release seems to have **broken paging**, details [below](#big-trouble)
...
Unknown Reference Number  <a name="big-trouble">  
**Paging seems broken with a recent API release** but I'm not able to report it yet.
...
Quarterly or so they'll update https://patentsview.org/release-notes  Another indication of
