...
To not bury the lead, the 2024-11-06 API release seems to have **broken paging by patent_id**, details [below](#big-trouble)
...
## Issues
* As mentioned up top, the 2024-11-06 API release seems to have broken paging by patent_id, details [below](#big-trouble)
...
I think I figured out a work around:  if the after: parameter contains a patent_id, it needs to 
