...
#> 
#> List of 1
#>  $ patents:'data.frame':	9057 obs. of  7 variables:
#>   ..$ patent_id                       : chr [1:9057] "4653043" ...
#>   ..$ patent_date                     : chr [1:9057] "1987-03-24" ...
#>   ..$ patent_year                     : int [1:9057] 1987 1988 ...
#>   ..$ patent_earliest_application_date: chr [1:9057] "1985-07-01" ...
#>   ..$ patent_num_us_patents_cited     : int [1:9057] 12 3 ...
#>   ..$ application                     :List of 9057
#>   ..$ assignees                       :List of 9057
#> 
#> $query_results
...
dl
#> List of 3
#>  $ application:'data.frame':	9057 obs. of  2 variables:
#>   ..$ patent_id  : chr [1:9057] "4653043" ...
#>   ..$ filing_date: chr [1:9057] "1985-07-01" ...
#>  $ assignees  :'data.frame':	8558 obs. of  3 variables:
#>   ..$ patent_id            : chr [1:8558] "4653043" ...
#>   ..$ assignee             : chr [1:8558] "https://search.patentsview.org/api"..
#>   ..$ assignee_organization: chr [1:8558] "AT&T Bell Laboratories" ...
#>  $ patents    :'data.frame':	9057 obs. of  5 variables:
#>   ..$ patent_id                       : chr [1:9057] "4653043" ...
#>   ..$ patent_date                     : chr [1:9057] "1987-03-24" ...
#>   ..$ patent_year                     : int [1:9057] 1987 1988 ...
#>   ..$ patent_earliest_application_date: chr [1:9057] "1985-07-01" ...
...
#>   ..$ assignee_id          : chr [1:75] "04c06aad-bd6a-4925-9991-863802752c56"..
#>   ..$ assignee_organization: chr [1:75] "International Business Machines Corp"..
#>   ..$ assignee_num_patents : int [1:75] 161317 2701 ...
...
|:-------------------------------------------|---------:|-------:|--------:|------------:|:-------|
|International Business Machines Corporation | 0.4668579|     808|   161317|        0.005|#f1c40f |
|SONY GROUP CORPORATION                      | 0.3713147|      27|    61292|        0.000|#f1c40f |
|Fujitsu Limited                             | 0.4037503|      45|    56102|        0.001|#f1c40f |
|General Electric Company                    | 0.4488619|      24|    51234|        0.000|#f1c40f |
|Intel Corporation                           | 0.3463383|      20|    50627|        0.000|#f1c40f |
|HITACHI, LTD.                               | 0.3608380|      50|    45755|        0.001|#f1c40f |
