...
#> 
#> List of 1
#>  $ patents:'data.frame':	7894 obs. of  5 variables:
#>   ..$ patent_id                  : chr [1:7894] "10000987" ...
#>   ..$ patent_date                : chr [1:7894] "2018-06-19" ...
#>   ..$ patent_year                : int [1:7894] 2018 2018 ...
#>   ..$ patent_num_us_patents_cited: int [1:7894] 163 7 ...
#>   ..$ assignees                  :List of 7894
#> 
#> $query_results
...
dl
#> List of 2
#>  $ assignees:'data.frame':	7438 obs. of  3 variables:
#>   ..$ patent_id            : chr [1:7438] "10000987" ...
#>   ..$ assignee             : chr [1:7438] "https://search.patentsview.org/api"..
#>   ..$ assignee_organization: chr [1:7438] "National Oilwell Varco, L.P." ...
#>  $ patents  :'data.frame':	7894 obs. of  4 variables:
#>   ..$ patent_id                  : chr [1:7894] "10000987" ...
#>   ..$ patent_date                : chr [1:7894] "2018-06-19" ...
#>   ..$ patent_year                : int [1:7894] 2018 2018 ...
#>   ..$ patent_num_us_patents_cited: int [1:7894] 163 7 ...
...
assignee_counts
#> List of 1
#>  $ assignees:'data.frame':	72 obs. of  3 variables:
#>   ..$ assignee_id          : chr [1:72] "00501db1-74e4-4dc5-a2a3-ba81577d157e"..
#>   ..$ assignee_organization: chr [1:72] "Lucent Technologies Inc." ...
#>   ..$ assignee_num_patents : int [1:72] 9435 7431 ...
...
|:-------------------------------------------|---------:|-------:|--------:|------------:|:-------|
|International Business Machines Corporation | 0.4671046|     769|   153889|        0.005|#f1c40f |
|Canon Kabushiki Kaisha                      | 0.4955864|      12|    81768|        0.000|#f1c40f |
|Sony Corporation                            | 0.3594824|      24|    61802|        0.000|#f1c40f |
|General Electric Company                    | 0.4476709|      24|    49483|        0.000|#f1c40f |
|Intel Corporation                           | 0.3521320|      20|    47722|        0.000|#f1c40f |
|Hitachi, Ltd.                               | 0.3605432|      50|    42726|        0.001|#f1c40f |
