...
assignee_counts <- unnest_pv_data(assignee_out$data, "patent_number")
...
# TODO: the rest of the file isn't implemented yet, the start and end{r} lines are commented out
# trying to see if the builds work
