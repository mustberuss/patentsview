...
#> 
#> List of 1
#>  $ patents:'data.frame':	8515 obs. of  5 variables:
#>   ..$ patent_id                  : chr [1:8515] "10000987" ...
#>   ..$ patent_date                : chr [1:8515] "2018-06-19" ...
#>   ..$ patent_year                : int [1:8515] 2018 2018 ...
#>   ..$ patent_num_us_patents_cited: int [1:8515] 163 7 ...
#>   ..$ assignees                  :List of 8515
#> 
#> $query_results
...
dl
#> List of 2
#>  $ assignees:'data.frame':	8038 obs. of  3 variables:
#>   ..$ patent_id            : chr [1:8038] "10000987" ...
#>   ..$ assignee             : chr [1:8038] "https://search.patentsview.org/api"..
#>   ..$ assignee_organization: chr [1:8038] "National Oilwell Varco, L.P." ...
#>  $ patents  :'data.frame':	8515 obs. of  4 variables:
#>   ..$ patent_id                  : chr [1:8515] "10000987" ...
#>   ..$ patent_date                : chr [1:8515] "2018-06-19" ...
#>   ..$ patent_year                : int [1:8515] 2018 2018 ...
#>   ..$ patent_num_us_patents_cited: int [1:8515] 163 7 ...
...
#>   ..$ assignee_id          : chr [1:75] "00bbd2c6-ccfc-4f71-80a9-9363e11d7ca2"..
#>   ..$ assignee_organization: chr [1:75] "ORACLE INTERNATIONAL CORPORATION" ...
#>   ..$ assignee_num_patents : int [1:75] 9519 30227 ...
...
|:-------------------------------------------|---------:|-------:|--------:|------------:|:-------|
|International Business Machines Corporation | 0.4675192|     789|   158577|        0.005|#f1c40f |
|SONY CORPORATION                            | 0.3683009|      25|    59883|        0.000|#f1c40f |
|FUJITSU LIMITED                             | 0.4012919|      44|    55866|        0.001|#f1c40f |
|General Electric Company                    | 0.4488619|      24|    50519|        0.000|#f1c40f |
|Intel Corporation                           | 0.3463383|      20|    48691|        0.000|#f1c40f |
|Hitachi, Ltd.                               | 0.3608380|      50|    43165|        0.001|#f1c40f |
