...
#> 
#> List of 1
#>  $ patents:'data.frame':	1013 obs. of  7 variables:
#>   ..$ patent_id                       : chr [1:1013] "4653043" ...
#>   ..$ patent_date                     : chr [1:1013] "1987-03-24" ...
#>   ..$ patent_year                     : int [1:1013] 1987 1988 ...
#>   ..$ patent_earliest_application_date: chr [1:1013] "1985-07-01" ...
#>   ..$ patent_num_us_patents_cited     : int [1:1013] 12 3 ...
#>   ..$ application                     :List of 1013
#>   ..$ assignees                       :List of 1013
#> 
#> $query_results
...
dl
#> List of 3
#>  $ application:'data.frame':	1013 obs. of  2 variables:
#>   ..$ patent_id  : chr [1:1013] "4653043" ...
#>   ..$ filing_date: chr [1:1013] "1985-07-01" ...
#>  $ assignees  :'data.frame':	929 obs. of  3 variables:
#>   ..$ patent_id            : chr [1:929] "4653043" ...
#>   ..$ assignee             : chr [1:929] "https://search.patentsview.org/api/"..
#>   ..$ assignee_organization: chr [1:929] "AT&T Bell Laboratories" ...
#>  $ patents    :'data.frame':	1013 obs. of  5 variables:
#>   ..$ patent_id                       : chr [1:1013] "4653043" ...
#>   ..$ patent_date                     : chr [1:1013] "1987-03-24" ...
#>   ..$ patent_year                     : int [1:1013] 1987 1988 ...
#>   ..$ patent_earliest_application_date: chr [1:1013] "1985-07-01" ...
...
#>   ..$ assignee_num_patents : int [1:75] 24081 30584 ...
...
|:-------------------------------------------|---------:|-------:|--------:|------------:|:-------|
|International Business Machines Corporation | 0.4857272|     109|   161317|        0.001|#f1c40f |
|SONY GROUP CORPORATION                      | 0.3944270|       6|    61292|        0.000|#f1c40f |
|Fujitsu Limited                             | 0.5211083|      15|    56102|        0.000|#f1c40f |
|Intel Corporation                           | 0.3860855|       3|    50627|        0.000|#f1c40f |
|HITACHI, LTD.                               | 0.2960192|       8|    45755|        0.000|#f1c40f |
|MITSUBISHI ELECTRIC CORPORATION             | 0.3914600|       5|    44168|        0.000|#f1c40f |
