...
#> 
#> List of 1
#>  $ patents:'data.frame':	9425 obs. of  7 variables:
#>   ..$ patent_id                       : chr [1:9425] "10000987" ...
#>   ..$ patent_date                     : chr [1:9425] "2018-06-19" ...
#>   ..$ patent_year                     : int [1:9425] 2018 2018 ...
#>   ..$ patent_earliest_application_date: chr [1:9425] "2014-02-20" ...
#>   ..$ patent_num_us_patents_cited     : int [1:9425] 163 7 ...
#>   ..$ application                     :List of 9425
#>   ..$ assignees                       :List of 9425
#> 
#> $query_results
...
dl
#> List of 3
#>  $ application:'data.frame':	9425 obs. of  7 variables:
#>   ..$ patent_id       : chr [1:9425] "10000987" ...
#>   ..$ application_id  : chr [1:9425] "14/185552" ...
#>   ..$ application_type: chr [1:9425] "14" ...
#>   ..$ filing_date     : chr [1:9425] "2014-02-20" ...
#>   ..$ series_code     : chr [1:9425] "14" ...
#>   ..$ rule_47_flag    : logi [1:9425] TRUE ...
#>   ..$ filing_type     : chr [1:9425] "14" ...
#>  $ assignees  :'data.frame':	8920 obs. of  12 variables:
#>   ..$ patent_id                     : chr [1:8920] "10000987" ...
#>   ..$ assignee                      : chr [1:8920] "https://search.patentsvie"..
#>   ..$ assignee_id                   : chr [1:8920] "661aac33-90aa-467b-88ac-1"..
#>   ..$ assignee_type                 : chr [1:8920] "2" ...
#>   ..$ assignee_individual_name_first: chr [1:8920] NA ...
#>   ..$ assignee_individual_name_last : chr [1:8920] NA ...
#>   ..$ assignee_organization         : chr [1:8920] "National Oilwell Varco, L"..
#>   ..$ assignee_location_id          : chr [1:8920] "4e49a0a0-16c8-11ed-9b5f-1"..
#>   ..$ assignee_city                 : chr [1:8920] "Houston" ...
#>   ..$ assignee_state                : chr [1:8920] "TX" ...
#>   ..$ assignee_country              : chr [1:8920] "US" ...
#>   ..$ assignee_sequence             : int [1:8920] 0 0 ...
#>  $ patents    :'data.frame':	9425 obs. of  5 variables:
#>   ..$ patent_id                       : chr [1:9425] "10000987" ...
#>   ..$ patent_date                     : chr [1:9425] "2018-06-19" ...
#>   ..$ patent_year                     : int [1:9425] 2018 2018 ...
#>   ..$ patent_earliest_application_date: chr [1:9425] "2014-02-20" ...
...
#>   ..$ assignee_id          : chr [1:75] "0184ec6a-176c-49f5-8a06-f19bf3bba594"..
#>   ..$ assignee_organization: chr [1:75] "MOBILE TECHNOLOGY CORPORATION" ...
#>   ..$ assignee_num_patents : int [1:75] 101 140 ...
...
|:-------------------------------------------|---------:|-------:|--------:|------------:|:-------|
|International Business Machines Corporation | 0.4678054|     815|   162903|        0.005|#f1c40f |
|SONY GROUP CORPORATION                      | 0.3554624|      29|    62327|        0.000|#f1c40f |
|Fujitsu Limited                             | 0.4034433|      45|    56238|        0.001|#f1c40f |
|Intel Corporation                           | 0.3462831|      20|    52140|        0.000|#f1c40f |
|General Electric Company                    | 0.4491179|      24|    51686|        0.000|#f1c40f |
|HITACHI, LTD.                               | 0.3609991|      50|    43634|        0.001|#f1c40f |
