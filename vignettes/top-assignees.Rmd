...
#> 
#> List of 1
#>  $ patents:'data.frame':	8662 obs. of  5 variables:
#>   ..$ patent_id                  : chr [1:8662] "10000987" ...
#>   ..$ patent_date                : chr [1:8662] "2018-06-19" ...
#>   ..$ patent_year                : int [1:8662] 2018 2018 ...
#>   ..$ patent_num_us_patents_cited: int [1:8662] 163 7 ...
#>   ..$ assignees                  :List of 8662
#> 
#> $query_results
...
dl
#> List of 2
#>  $ assignees:'data.frame':	8177 obs. of  3 variables:
#>   ..$ patent_id            : chr [1:8177] "10000987" ...
#>   ..$ assignee             : chr [1:8177] "https://search.patentsview.org/api"..
#>   ..$ assignee_organization: chr [1:8177] "National Oilwell Varco, L.P." ...
#>  $ patents  :'data.frame':	8662 obs. of  4 variables:
#>   ..$ patent_id                  : chr [1:8662] "10000987" ...
#>   ..$ patent_date                : chr [1:8662] "2018-06-19" ...
#>   ..$ patent_year                : int [1:8662] 2018 2018 ...
#>   ..$ patent_num_us_patents_cited: int [1:8662] 163 7 ...
...
#>   ..$ assignee_id          : chr [1:75] "02e56eeb-7980-44b2-a374-704019adea73"..
#>   ..$ assignee_organization: chr [1:75] "i2 Technologies US, Inc." ...
#>   ..$ assignee_num_patents : int [1:75] 197 1519 ...
...
|:-------------------------------------------|---------:|-------:|--------:|------------:|:-------|
|International Business Machines Corporation | 0.4673187|     794|   159333|        0.005|#f1c40f |
|SONY CORPORATION                            | 0.3615332|      26|    60198|        0.000|#f1c40f |
|FUJITSU LIMITED                             | 0.4012456|      44|    55858|        0.001|#f1c40f |
|General Electric Company                    | 0.4488619|      24|    50730|        0.000|#f1c40f |
|Intel Corporation                           | 0.3463383|      20|    49196|        0.000|#f1c40f |
|HITACHI, LTD.                               | 0.3608380|      50|    45547|        0.001|#f1c40f |
