...
query_v_1 <-
  '{"_and":[
          ...
          {"_or":[
            {"_text_phrase":{"inventors_at_grant.country":"US"}},
            {"_text_phrase":{"inventors_at_grant.country":"CA"}}
          ]}
  ]}'
```
...
query_v_2 <- 
  list("_and" = 
       list(
          ...
          list("_or" = 
                 list(
                   list("_text_phrase" = list(inventors_at_grant.country = "US")),
                   list("_text_phrase" = list(inventors_at_grant.country = "CA"))
                   )
               )
      )
  )
...
query_v_3 <- 
  with_qfuns(
    and(
      ...
      or(
        text_phrase(inventors_at_grant.country = "US"),
        text_phrase(inventors_at_grant.country = "CA")
      )
    )
  )
```
...
#> {"_and":[{"_gte":{"patent_date":"2007-03-01"}},{"_or":[{"_contains":{"patent_title":"dog"}},{"_text_all":{"patent_abstract":"dog"}}]},{"_or":[{"_text_phrase":{"inventors_at_grant.country":"US"}},{"_text_phrase":{"inventors_at_grant.country":"CA"}}]}]}
...
with_qfuns(
  and(
    text_any(inventors_at_grant.name_first = "kevin"),  # inventor names are now full text
...
#> {"_and":[{"_text_any":{"inventors_at_grant.name_first":"kevin"}},{"_or":[{"_text_phrase":{"patent_abstract":"dog bark"}},{"_text_phrase":{"patent_abstract":"cat meow"}}]},{"_not":{"_text_phrase":{"patent_abstract":"dog chain"}}}]}
```
...
with_qfuns(
  or(
    and(
      eq(inventors_at_grant.name_last = "smith"),
      contains(patent_title = "cotton gin")
    ),
    and(
      eq(inventors_at_grant.name_last = "turner"),
      contains(patent_title = "COBOL")
    )
  )
)
#> {"_or":[{"_and":[{"_eq":{"inventors_at_grant.name_last":"smith"}},{"_contains":{"patent_title":"cotton gin"}}]},{"_and":[{"_eq":{"inventors_at_grant.name_last":"turner"}},{"_contains":{"patent_title":"COBOL"}}]}]}
```
